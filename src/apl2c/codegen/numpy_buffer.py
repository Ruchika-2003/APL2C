...
class NumpyBuffer(Buffer):
    ...
    def ftype(self):
        ...
        """
        return NumpyBufferFType(self.arr.dtype.type, self.arr.ndim)
...
class NumpyBufferFType(CBufferFType):
    ...
    def __init__(self, dtype: type, ndim: int):
    ...
    def __str__(self):
        return f"np_buf_t({qual_str(self._dtype)}, ndim={self._ndim})"
    ...
    def c_alloc(self, ctx, shape):
        ...
        alloc_name = f"alloc_{self._dtype.__name__}"
